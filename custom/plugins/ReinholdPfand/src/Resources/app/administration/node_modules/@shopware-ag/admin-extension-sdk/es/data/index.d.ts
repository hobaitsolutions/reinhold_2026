...
export declare const get: (messageOptions: import("../channel").MessageDataType<"datasetGet">) => Promise<unknown>;
...
export declare const handleGet: (method: (data: import("../channel").MessageDataType<"datasetGet">, additionalInformation: {
