...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./_internals/utils", "./privileges/privilege-resolver", "./privileges", "./privileges/missing-privileges-error", "./_internals/serializer", "./_internals/error-handling/error-factory", "./_internals/validator/index", "./data/_internals/selectData", "./_internals/sdkVersion"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.processDataRegistration = exports.createSubscriber = exports.createHandler = exports.createSender = exports.subscribe = exports.publish = exports.handle = exports.send = exports.setExtensions = exports.adminExtensions = void 0;
    ...
    const index_1 = __importDefault(require("./_internals/validator/index"));
    const selectData_1 = require("./data/_internals/selectData");
    ...
    window._swsdk = {
        ...
        subscriberRegistry,
        datasets,
        adminExtensions: exports.adminExtensions,
    };
    /**
     * ----------------
