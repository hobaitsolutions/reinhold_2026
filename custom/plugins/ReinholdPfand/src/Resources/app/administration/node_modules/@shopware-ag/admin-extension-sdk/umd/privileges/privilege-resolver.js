(function (factory) {
    ...
    exports.findExtensionByBaseUrl = exports.handlePrivileged = exports.sendPrivileged = void 0;
    const _1 = require(".");
    ...
    exports.handlePrivileged = handlePrivileged;
    function getRequiredPrivilegesForMessage(messageType) {
        var _a;
        return (_a = _1.ShopwareMessageTypePrivileges[messageType]) !== null && _a !== void 0 ? _a : {};
    }
