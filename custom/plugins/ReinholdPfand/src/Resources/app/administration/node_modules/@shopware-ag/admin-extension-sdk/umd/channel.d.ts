...
export declare const adminExtensions: extensions;
 ...
 */
export declare function createHandler<MESSAGE_TYPE extends keyof ShopwareMessageTypes>(messageType: MESSAGE_TYPE): (method: (data: MessageDataType<MESSAGE_TYPE>, additionalInformation: {
    _event_: MessageEvent<string>;
}) => Promise<ShopwareMessageTypes[MESSAGE_TYPE]['responseType']> | ShopwareMessageTypes[MESSAGE_TYPE]['responseType']) => () => void;
/**
 * Factory method which creates a handler so that the type don't need to be
