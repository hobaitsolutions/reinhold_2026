...
export declare const getShopwareVersion: (messageOptions?: import("../channel").MessageDataType<"contextShopwareVersion"> | undefined) => Promise<string>;
export declare const getUserInformation: (messageOptions?: import("../channel").MessageDataType<"contextUserInformation"> | undefined) => Promise<{
    aclRoles: Array<{
        name: string;
        type: string;
        id: string;
...
export declare const getAppInformation: (messageOptions?: import("../channel").MessageDataType<"contextAppInformation"> | undefined) => Promise<{
    name: string;
    version: string;
    type: 'app' | 'plugin';
}>;
export declare const getModuleInformation: (messageOptions?: import("../channel").MessageDataType<"contextModuleInformation"> | undefined) => Promise<{
    modules: Array<{
