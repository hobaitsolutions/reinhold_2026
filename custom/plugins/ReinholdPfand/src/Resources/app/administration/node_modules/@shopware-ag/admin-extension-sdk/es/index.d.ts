...
declare const ui: {
    ...
    tabs: (tabPositionId: string) => {
        addTabItem: (messageOptions: Omit<import("./channel").MessageDataType<"uiTabsAddTabItem">, "positionId">) => Promise<void>;
    };
    menu: typeof menu;
 ...
 */
export { window, notification, context, ui, cms, location, app, data, composables, };
/**
