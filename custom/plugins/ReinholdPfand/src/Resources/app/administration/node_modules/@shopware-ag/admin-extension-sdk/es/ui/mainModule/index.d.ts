export declare const addMainModule: (messageOptions: import("../../channel").MessageDataType<"mainModuleAdd">) => Promise<void>;
export declare const addSmartBarButton: (messageOptions: import("../../channel").MessageDataType<"smartBarButtonAdd">) => Promise<void>;
